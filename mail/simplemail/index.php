<?php
/**
$txt = "===adadadadadadasatext===";

// Use wordwrap() if lines are longer than 70 characters
$txt = wordwrap($txt,70);

// Send email
mail("461815849@qq.com","My subject",$txt);
...
function sendmailto($mailto, $mailsub, $mailbd)
{
    ...
    $smtpusermail   = "shizhe_php@163.com"; //SMTP服务器的用户邮箱
    $smtpemailto    = $mailto;
    $smtpuser       = "shizhe_php@163.com"; //SMTP服务器的用户帐号
    $smtppass       = "shizhe123456"; //SMTP服务器的用户密码
